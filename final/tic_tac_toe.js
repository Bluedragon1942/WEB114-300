...
const showWinner = function (winner) {
    ...
    msg.textContent = "Congratulations! " + winnerName + " wins!";

    let winnerGif = document.createElement("img");
    winnerGif.src = "https://media1.tenor.com/m/GWewIVSoJBcAAAAC/yippee.gif";
    winnerGif.alt = "Yippee celebration gif";
    winnerGif.style.width = "150px";
    winnerGif.style.marginTop = "10px";

    msg.appendChild(document.createElement("br"));
    msg.appendChild(winnerGif);
    msg.appendChild(document.createElement("br"));
    msg.appendChild(document.createElement("br"));
